...
console.log("Total cost using updated function is $" + getTotalBillUpdated(costs, numOfEach));
...
console.log("Total cost using array of objects is $" + getTotalBillObjects(items));
